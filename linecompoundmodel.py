...
A = st.sidebar.number_input("Parabola Coefficient (A)", value=1.0E+01,  format="%.2E")
y_peak = st.sidebar.number_input("Peak Gibbs Energy (J/mol)", value=-2.513796E+03,  format="%.2E")
