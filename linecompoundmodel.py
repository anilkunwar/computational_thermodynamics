...
A = st.sidebar.slider("Parabola Coefficient (A)", min_value=1, max_value=200, value=100, step=1)
y_peak = st.sidebar.number_input("Peak Gibbs Energy (J/mol)", value=-50.0, step=0.1)
