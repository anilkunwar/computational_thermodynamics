...
A = st.sidebar.slider("Parabola Coefficient (A)", min_value=1.0E+05, max_value=1.0E+07, value=1.0E+06, step=1.0E+05, format="%.2E")
y_peak = st.sidebar.number_input("Peak Gibbs Energy (J/mol)", min_value=1.0E+05, max_value=1.0E+07, value=-2.513796E+03, step=1.0E+02,  format="%.2E")
